...
$idDia = recoge("idDia");
$hora = recoge("hora");
$recomendacion = recoge("recomendacion");
...
if ($recomendacion == "") {
  ...
  $recomendacionOk = true;
}

if ($padecimiento == "") {
  print "  <p class=\"aviso\">No ha escrito el padecimiento del paciente.</p>\n";
  print "\n";
} else {
  $padecimientoOk = true;
}

if ($nombrePacienteOk && $cedulaOk && $correoOk && $idDoctorOk && $idDiaOk && $horaOk && $descripcionOk && $recomendacionOk && $padecimientoOk) {

  include 'connection.php';

  //echo($idCita.$recomendacion.$padecimiento."  a a a a");
  echo json_encode(insertaDatosCita($idCita,$recomendacion,$padecimiento));
}
