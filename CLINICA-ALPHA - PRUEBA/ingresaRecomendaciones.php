...
<head>
    ...
    <script src="js/rec_pade.js"></script>
...
<body>
    ...
    <div class="row">
        ...
        <div id="formCitas" class="main">
            <strong><span id="idFotograma" style="font-family: Arial; font-size: 24pt">Ingresa Recomendaciones y Padecimientos del paciente</span></strong><br />
            <br />
            ...
            <div style="text-align: left; font-family: Arial">
                ...
                <span id="sHora">
                    ...
                    Recomendaciones:<br />
                    <textarea name="recomendacion" rows="2" cols="20" id="recomendacion" style="height:64px;width:440px;"></textarea><br />
                    Padecimientos:<br />
                    <textarea name="padecimiento" rows="2" cols="20" id="padecimiento" style="height:64px;width:440px;"></textarea><br />
